...
| `codelink.server.host` | `"127.0.0.1"` | Bind address. **Only takes effect when `codelink.remote.enabled` is `true`** — otherwise CodeLink always binds `127.0.0.1`, regardless of this setting. See [remote-access.md](remote-access.md). |
